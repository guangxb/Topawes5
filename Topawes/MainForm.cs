...
namespace Topawes
{
    public partial class MainForm : Form
    {
        ...
        internal MainForm()
        {
            ...
            this.FormClosing += WinFormsClient_FormClosing;
        }
        ...
        private async void ConnectAsync()
        {
            ...
            try
            {
                ...
                this.tssl_ConnState.Text = "连接状态：" + Microsoft.AspNet.SignalR.Client.ConnectionState.Connected.AsZhConnectionState();
                IsLogin = true;
        ...
        private void LoadUserSetting()
        {
            this.InvokeAction(() =>
            {
                ...
                var closeReasons = new string[] { TradeCloseReason.与买家协商一致, TradeCloseReason.买家不想买, TradeCloseReason.买家联系不上, TradeCloseReason.协商不一致, TradeCloseReason.商品瑕疵, TradeCloseReason.未及时付款, TradeCloseReason.谢绝还价 };
                关单原因.SetupAfterUserSettingInitialized("关单原因", closeReasons, TradeCloseReason.未及时付款);
            });
        }
